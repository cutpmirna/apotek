...
<body>
    <?php                
        include ("Koneksi.php");
        $kodeproduk = $_GET['kodeobat'];
        $query_select = "SELECT * FROM produk WHERE kodeobat = '$kodeproduk'";
    ...
    <table border="0" id= "table1"style="border-collapse:collapse ;">
        ...
        <tr>
             <td colspan="3" style="color:black ; text-align:center" > Form Edit Produk</td> 
         </tr>
            ...
            <tr>
                <td>Nama Obat</td>
                <td><input type="text" name="namaobat" placeholder="Masukkan nama obat.." value ="<?php echo $row['namaobat'] ?>"></td>
            </tr>
            <tr>
                <td>Satuan</td>
                <td><input type="text" name="satuan" placeholder="Masukkan satuan.."value ="<?php echo $row['satuan'] ?>"></td>
            </tr><tr>
                <td>Harga (Rp)</td>
                <td><input type="text" name="harga" placeholder="Masukkan harga.."value ="<?php echo $row['harga'] ?>"></td>
            </tr>
            <tr>
            
                <td colspan="2" id="submit"><input type="submit" name="perbaharui" value="update"></td>
            </tr>
         </table>
        </td>
        </tr>
